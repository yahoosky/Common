...
public class MessageLogger {
	final static LoggerHelper helper = new LoggerHelper();
	 ...
	 * 显示时间
	 */
	protected static final Boolean TIMER = Boolean.FALSE;
	 ...
	 * @version v1.0
	 */
	public static void debug(String category, String msg, String... info) {

		if (TIMER) {
			System.out.println(Calendar.getInstance().getTimeInMillis());
		}
		helper.getLogger(category).debug(getMsg(msg, null, info));
	}
	 ...
	 * @version v1.0
	 */
	public static void info(String category, String msg, String... info) {
		if (TIMER) {
			System.out.println(Calendar.getInstance().getTimeInMillis());
		}
		helper.getLogger(category).info(getMsg(msg, null, info));
	}
	 ...
	 * @version v1.0
	 */
	public static void error(String category, String msg, Throwable e, String... info) {
		if (TIMER) {
			System.out.println(Calendar.getInstance().getTimeInMillis());
		}
		helper.getLogger(category).error(getMsg(msg, e, info));
	}
	 ...
	 * @param info
	 */
	public static void tradeStep(String category, String msg, String... info) {
		if (TIMER) {
			System.out.println(Calendar.getInstance().getTimeInMillis());
		}
		helper.getLogger(category).info(getMsg(msg, null, info));
	 ...
	 * @param info
	 */
	public static void secret(String category, String msg, String... info) {
		if (TIMER) {
			System.out.println(Calendar.getInstance().getTimeInMillis());
		}
		helper.getLogger(category).debug(getMsg(msg, null, info));
	 ...
	 * @return
	 */
	protected static String getMsg(String msg, Throwable e, String... info) {
	 ...
	 */
	protected static void getExcpMsg(String tradeId, Throwable excp, StringBuilder rtnMsg) {
		if (excp != null) {
			rtnMsg.append(tradeId).append(BLANK_SPACE).append("Exception as").append(excp.getClass().getName())
					.append('\n')//
					.append("message :").append(excp.getMessage()).append('\n');
			for (StackTraceElement trace : excp.getStackTrace()) {
				rtnMsg.append(tradeId).append(BLANK_SPACE).append(BLANK_SPACE).append(trace.getClassName()).append(".")
						.append(trace.getMethodName()).append(BLANK_SPACE).append(trace.getLineNumber()).append("\n");
			}
